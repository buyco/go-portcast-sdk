...
// APIClient manages communication with the Portcast API (1.1.0) - Bill of Lading Tracking API v1.0.0
...
type APIClient struct {
	...
	BillOfLadingBookmarksApi BillOfLadingBookmarksApi

	BookingBookmarksApi BookingBookmarksApi
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BillOfLadingBookmarksApi = (*BillOfLadingBookmarksApiService)(&c.common)
	c.BookingBookmarksApi = (*BookingBookmarksApiService)(&c.common)
