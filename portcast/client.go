...
// APIClient manages communication with the Container Tracking API API v2.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.UploadContainersForTrackingAPI = (*UploadContainersForTrackingAPIService)(&c.common)
