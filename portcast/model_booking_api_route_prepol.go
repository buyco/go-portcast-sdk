...
// checks if the BookingAPIRoutePrepol type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BookingAPIRoutePrepol{}
...
type NullableBookingAPIRoutePrepol struct {
	value *BookingAPIRoutePrepol
	isSet bool
}

func (v NullableBookingAPIRoutePrepol) Get() *BookingAPIRoutePrepol {
	return v.value
}

func (v *NullableBookingAPIRoutePrepol) Set(val *BookingAPIRoutePrepol) {
	v.value = val
	v.isSet = true
}

func (v NullableBookingAPIRoutePrepol) IsSet() bool {
	return v.isSet
}
...
func NewNullableBookingAPIRoutePrepol(val *BookingAPIRoutePrepol) *NullableBookingAPIRoutePrepol {
	return &NullableBookingAPIRoutePrepol{value: val, isSet: true}
}
