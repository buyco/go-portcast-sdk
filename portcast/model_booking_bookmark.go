...
// BookingBookmark struct for BookingBookmark
type BookingBookmark struct {
...
func (dst *BookingBookmark) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("Data failed to match schemas in anyOf(BookingBookmark)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *BookingBookmark) MarshalJSON() ([]byte, error) {
...
type NullableBookingBookmark struct {
	value *BookingBookmark
	isSet bool
}

func (v NullableBookingBookmark) Get() *BookingBookmark {
	return v.value
}

func (v *NullableBookingBookmark) Set(val *BookingBookmark) {
	v.value = val
	v.isSet = true
}

func (v NullableBookingBookmark) IsSet() bool {
	return v.isSet
}

func (v *NullableBookingBookmark) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBookingBookmark(val *BookingBookmark) *NullableBookingBookmark {
	return &NullableBookingBookmark{value: val, isSet: true}
}

func (v NullableBookingBookmark) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBookingBookmark) UnmarshalJSON(src []byte) error {
	v.isSet = true
