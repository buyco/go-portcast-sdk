...
> DeleteTrackingBillOfLadingBookmarksBookmarkId200Response DeleteTrackingBillOfLadingBookmarksBookmarkId(ctx, bookmarkId).XCustomer(xCustomer).Execute()
...
func main() {
	...
	resp, r, err := apiClient.GetTrackingDataForUploadedContainersAPI.DeleteTrackingBillOfLadingBookmarksBookmarkId(context.Background(), bookmarkId).XCustomer(xCustomer).Execute()
	if err != nil {
...
> GetApiV1EtaBillOfLadingBookmarks200Response GetApiV1EtaBillOfLadingBookmarks(ctx, bookmarkId).XCustomer(xCustomer).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GetTrackingDataForUploadedContainersAPI.GetApiV1EtaBillOfLadingBookmarks(context.Background(), bookmarkId).XCustomer(xCustomer).Execute()
	if err != nil {
...
> ListApiV1EtaBillOfLadingBookmarks200Response ListApiV1EtaBillOfLadingBookmarks(ctx).CarrierNo(carrierNo).BlNo(blNo).CntrNo(cntrNo).StartAfter(startAfter).XCustomer(xCustomer).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GetTrackingDataForUploadedContainersAPI.ListApiV1EtaBillOfLadingBookmarks(context.Background()).CarrierNo(carrierNo).BlNo(blNo).CntrNo(cntrNo).StartAfter(startAfter).XCustomer(xCustomer).Execute()
	if err != nil {
